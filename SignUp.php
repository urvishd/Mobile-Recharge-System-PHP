...
<head>
    ...
    <!-- Title Page-->
    <title>Sign Up-Freecharge</title>
        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4 " type="password" name="password1" required />
                                </div>
                            </div>
                                <div class="col-2">
                                <div class="input-group">
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="phone" minlength="10" maxlength="10" required>
                                </div>
                            </div>
                        </div>
                         <?php
                            
                                                if(isset($_SESSION["signu"]))
                                                {
                                                    echo '<div class="flex-col-c p-t-160">';
                                                    echo '<font color="red">';
                                                    echo $_SESSION['signu'];
                                                    echo '</font>';
                                                    echo '</div>';
                    ...
                    <br>
                     <button class="btn btn--radius-2 btn--green" onclick="window.location.href = 'index.php';">
                         <span>
